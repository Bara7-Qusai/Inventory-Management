...
public class tables {
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          // st.executeUpdate("insert into appuser (userRole,name,mobileNumber,email,password,address,status) values ('SuperAdmain','Super Admain','0912213340','mohamedalwsila@yahoo.com','246813579','sudan','Active')");
